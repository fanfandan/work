...
jQuery.fn.gallery = function(config) {
    ...
    var no_click;
    var positions = {
        current: {zIndex: 100, top: "50px",  left: "350px" },
        left: {zIndex: 50, top: "70px", left: "150px" },
        right: {zIndex: 25,  top: "70px", left: "609px" },
		none: {zIndex: 0,  top: "70px", left: "350px" }
    };
    var currentD = {width:"620px",height:"373px" };
